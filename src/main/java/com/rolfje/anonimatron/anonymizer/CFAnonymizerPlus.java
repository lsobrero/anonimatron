...
public class CFAnonymizerPlus extends CFAnonymizer implements Anonymizer {

    @Override
    public String getType() {
        return "COD_FISCALE_PLUS";
    }
    ...
    public Synonym anonymize(Object from, int size, boolean shortlived) {
        ...
        String shiftedString = doShift(srcString);
        String controlChar = (shiftedString.length() == 16)?controlCode(shiftedString.substring(0,15)):"";
        return new StringSynonym(getType(),
                (String) from,
                shiftedString.substring(0,15)+controlChar,
                shortlived
        );
    }
